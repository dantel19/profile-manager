...
<div class="col-md-3 left_col">
	<div class="left_col scroll-view">
		...
		<div class="sidebar-footer hidden-small">
            ...
            <a href="${pageContext.request.contextPath}/j_spring_security_logout" data-toggle="tooltip" data-placement="top" title="<spring:message code="common.signout" />"> <span class="glyphicon glyphicon-off" aria-hidden="true"></span></a>
		</div>
