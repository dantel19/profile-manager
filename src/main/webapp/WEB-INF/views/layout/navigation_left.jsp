   ...
   <div class="left_col scroll-view">
      <div class="navbar nav_title" style="border: 0;">
         <a href="${pageContext.request.contextPath}" class="site_title">
            <img
               src="${pageContext.request.contextPath}/resources/images/profile_manager_icon.png"
               alt="Profile Manager Panel" class="img_app" > 
      ...
      <div id="sidebar-menu"
            ...
            <ul class="nav side-menu">
               ...
               <li><a><i class="fa fa-edit"></i> Forms <span
                  ...
                  <ul class="nav child_menu">
                     ...
                     <li><a href="form_advanced.html">Advanced
                           Components</a></li>
                     <li><a href="form_validation.html">Form
                           Validation</a></li>
                     <li><a href="form_wizards.html">Form
                           Wizard</a></li>
                     <li><a href="form_upload.html">Form Upload</a></li>
                     <li><a href="form_buttons.html">Form
                           Buttons</a></li>
                  </ul></li>
               <li><a><i class="fa fa-desktop"></i> UI Elements
                  ...
                  <ul class="nav child_menu">
                     <li><a href="general_elements.html">General
                           Elements</a></li>
                     <li><a href="media_gallery.html">Media
                           Gallery</a></li>
               ...
               <li><a><i class="fa fa-bar-chart-o"></i> Data
                  ...
                  <ul class="nav child_menu">
                     ...
                     <li><a href="other_charts.html">Other
                           Charts</a></li>
                  </ul></li>
               <li><a><i class="fa fa-clone"></i>Layouts <span
                     class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                     <li><a href="fixed_sidebar.html">Fixed
                           Sidebar</a></li>
                     <li><a href="fixed_footer.html">Fixed
                           Footer</a></li>
                  </ul></li>
            </ul>
         </div>
         <div class="menu_section">
            <h3>Live On</h3>
            <ul class="nav side-menu">
               <li><a><i class="fa fa-bug"></i> Additional
                     Pages <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                     <li><a href="e_commerce.html">E-commerce</a></li>
                     <li><a href="projects.html">Projects</a></li>
                     <li><a href="project_detail.html">Project
                           Detail</a></li>
               ...
               <li><a><i class="fa fa-windows"></i> Extras <span
                  ...
                  <ul class="nav child_menu">
                     ...
                     <li><a href="pricing_tables.html">Pricing
                           Tables</a></li>
                  </ul></li>
               <li><a><i class="fa fa-sitemap"></i> Multilevel
                     Menu <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                     ...
                     <li><a>Level One<span
                        ...
                        <ul class="nav child_menu">
                           <li class="sub_menu"><a
                              href="level2.html">Level Two</a></li>
               ...
               <li><a href="javascript:void(0)"><i
                     ...
                     class="label label-success pull-right">Coming
                        Soon</span></a></li>
            </ul>
         </div>
