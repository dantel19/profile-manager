 ...
 *
 */
public class DataTablesRequestGrid implements java.io.Serializable {
   private static final long serialVersionUID = -4969037054519735213L;
   ...
   public DataTablesRequestGrid() {
      super();
      this.addedFilters = new ArrayList<SearchField>();
   }

   public DataTablesRequestGrid(Integer iDisplayStart, Integer iDisplayLength, String sEcho, String sSearch,
